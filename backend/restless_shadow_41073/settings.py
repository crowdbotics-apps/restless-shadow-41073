"""
Django settings for restless_shadow_41073 project.
...
ROOT_URLCONF = 'restless_shadow_41073.urls'
...
WSGI_APPLICATION = 'restless_shadow_41073.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_shadow_41073 API",
    "DESCRIPTION": "API documentation for restless_shadow_41073 App",
    "VERSION": "v1",
}
